...
//   const handleCustomPayPress = async (shouldPass = true) => {
//     try {
//       setLoading(true)
//       setError(null)
//       setToken(null)
//       const some_params = shouldPass ? params : errorParams
//       const aToken = await stripe.createTokenWithCard(some_params)
...
//       <Text style={styles.param}>Number: {some_params.number}</Text>
//       <Text style={styles.param}>Month: {some_params.expMonth}</Text>
//       <Text style={styles.param}>Year: {some_params.expYear}</Text>
//     </View>
//   )
...
//         loading={loading}
//         onPress={() => handleCustomPayPress(false)}
