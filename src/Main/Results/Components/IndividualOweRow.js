...
export default IndividualOweRow = (props) => {
    ...
    return(
        <Row style={{padding:10, borderTopWidth:1, borderColor:'#D3D3D3' }}>
            ...
            {props.you_owe ?
                ...
                <Col style={{justifyContent:'flex-start'}}>
                    <Text style={{alignSelf:'center', fontSize:24,
                        marginBottom:5, textAlign:'center', color:currentStyle.text.color}}>
                        {props.swap.percentage}%
                    </Text>
                    <Text style={{fontSize:36, color:currentStyle.text.color}}>
                        -
                    </Text>                
                </Col>}
            {props.they_owe ?
                <Col style={{justifyContent:'flex-start'}}>
                    <Text style={{alignSelf:'center', fontSize:20, marginBottom:5, 
                ...
                :
                <Col style={{justifyContent:'flex-start'}}>
                    <Text style={{alignSelf:'center', fontSize:24, marginBottom:5, 
                        textAlign:'center', color:currentStyle.text.color}}>
                        {props.swap.counter_percentage}%
                    </Text>
                    <Text style={{fontSize:36, color:currentStyle.text.color}}>
