...
export default TotalOweRow = (props) => {
  ...
  return(
    <Row style={{paddingTop:20, borderTopWidth:1, backgroundColor: currentStyle.background.color, borderColor:'#D3D3D3'}}>
      <Col style={{width:'25%'}}>
        <Text style={{fontSize:24, color: currentStyle.text.color}}>Total</Text>
      </Col>
      <Col>
        {props.you_owe_total ?
          <Text style={{fontSize:24, fontWeight:'600',textAlign:'center', color: currentStyle.text.color}}>
