    ...
    return(
        <Container style={{backgroundColor:currentStyle.background.color}}> 
            ...
            <SafeAreaView style={{flex:1,backgroundColor:currentStyle.header.color}}>
                ...
                <ScrollView style={{ flex:1, flexGrow:1,display:'flex', backgroundColor:currentStyle.background.color }}>
                    {/* <View style={{ backgroundColor:currentStyle.background.color, display:'flex',}}> */}
                    {/* PROFILE BIO */}
